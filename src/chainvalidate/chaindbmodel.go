...
func NewChainDbRoaModel(chainRoa *ChainRoa) *ChainDbRoaModel {
	...
	belogs.Debug("NewChainDbRoaModel():chainDbRoaModel.Id:", chainDbRoaModel.Id, "   len(chainRoa.ParentChainCerAlones):", len(chainRoa.ParentChainCerAlones))
...
func NewChainDbMftModel(chainMft *ChainMft) *ChainDbMftModel {
	...
	belogs.Debug("NewChainDbMftModel():chainDbMftModel.Id:", chainDbMftModel.Id, "   len(chainMft.ParentChainCerAlones):", len(chainMft.ParentChainCerAlones))
...
func NewChainDbAsaModel(chainAsa *ChainAsa) *ChainDbAsaModel {
	...
	belogs.Debug("NewChainDbAsaModel():chainDbAsaModel.Id:", chainDbAsaModel.Id, "   len(chainAsa.ParentChainCerAlones):", len(chainAsa.ParentChainCerAlones))
