...
func (c *ChainCertSql) ToChainCer() (chainCer ChainCer, err error) {
	chainCer.Id = c.Id

	cerModel := model.CerModel{}
	err = jsonutil.UnmarshalJson(c.JsonAll, &cerModel)
	if err != nil {
		belogs.Error("ToChainCer(): UnmarshalJson fail, jsonAll:", c.JsonAll)
		return chainCer, err
	}
	belogs.Debug("ToChainCer(): cerModel, err:", cerModel.String(), err)
...
func (c *ChainCertSql) ToChainCrl() (chainCrl ChainCrl, err error) {
	chainCrl.Id = c.Id
	...
	belogs.Debug("ToChainCrl(): crlModel:", crlModel.String())
...
func (c *ChainCertSql) ToChainMft() (chainMft ChainMft, err error) {
	chainMft.Id = c.Id

	mftModel := model.MftModel{}
	err = jsonutil.UnmarshalJson(c.JsonAll, &mftModel)
	if err != nil {
		belogs.Error("ToChainMft(): UnmarshalJson fail, jsonAll:", c.JsonAll)
		return chainMft, err
	}
	belogs.Debug("ToChainMft(): mftModel:", mftModel.String())
...
func (c *ChainCertSql) ToChainRoa() (chainRoa ChainRoa, err error) {
	chainRoa.Id = c.Id

	roaModel := model.RoaModel{}
	err = jsonutil.UnmarshalJson(c.JsonAll, &roaModel)
	if err != nil {
		belogs.Error("ToChainRoa(): UnmarshalJson fail, jsonAll:", c.JsonAll)
		return chainRoa, err
	}
	belogs.Debug("ToChainRoa(): roaModel:", roaModel.String())
...
func (c *ChainCertSql) ToChainAsa() (chainAsa ChainAsa, err error) {
	chainAsa.Id = c.Id
...
type ChainCertData struct {
	...
	CrlFileName    string    `json:"-" xorm:"crlFileName varchar(128)"`
	RevocationTime time.Time `json:"-" xorm:"revocationTime datetime"`
	IsRoot         bool      `json:"isRoot"` // 添加IsRoot字段
...
func (c *ChainCertData) ToChainCer() (chainCer ChainCer, err error) {
	chainCer.Id = c.Id
...
func (c *ChainCertData) ToChainCrl() (chainCrl ChainCrl, err error) {
	chainCrl.Id = c.Id
...
func (c *ChainCertData) ToChainMft() (chainMft ChainMft, err error) {
	chainMft.Id = c.Id
...
func (c *ChainCertData) ToChainRoa() (chainRoa ChainRoa, err error) {
	chainRoa.Id = c.Id
...
func (c *ChainCertData) ToChainAsa() (chainAsa ChainAsa, err error) {
	chainAsa.Id = c.Id
...
func (c ChainFileHash) String() string {
