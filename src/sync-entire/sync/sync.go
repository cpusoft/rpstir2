...
import (
	...
	"github.com/bgpsecurity/rpstir2/sync-core/sync"
	rpsync "github.com/bgpsecurity/rpstir2/sync-core/sync"
...
func localSyncStart() {
	...
	if err != nil {
		belogs.Error("localSyncStart():  servicestate leave sync fail, rpstir2RpUrl:", rpstir2RpUrl, err)
	}
...
func callLocalRsync(syncLogId uint64, syncLogSyncState *model.SyncLogSyncState) (err error) {
	...
	err = httpclient.PostAndUnmarshalResponseModelWithConfig("https://"+conf.String("rpstir2-rp::serverHost")+":"+conf.String("rpstir2-rp::serverHttpsPort")+
		"/entiresync/localrsyncrequest", syncUrlsJson,  &rsyncResult, httpclient.NewHttpClientConfigWithParam(5, 3, "all", false))
	if err != nil {
