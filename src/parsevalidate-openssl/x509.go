...
func ParseCerModelByX509(fileByte []byte, cerModel *model.CerModel) (err error) {
	...
	belogs.Debug("ParseCerModelByX509():cerModel:", cerModel.String())
	return nil
}
...
func ParseCrlModelByX509(fileByte []byte, crlModel *model.CrlModel) (err error) {
	...
	if err != nil {
		belogs.Error("ParseCrlModelByX509():ParseCRL fail, len(fileByte):", len(fileByte), err)
		return err
	}
	...
	belogs.Debug("ParseCrlModelByX509(): get crl, ThisUpdate:", crlModel.ThisUpdate, "  NextUpdate:", crlModel.NextUpdate,
	...
	belogs.Debug("ParseCrlModelByX509():crlModel:", crlModel.String())
